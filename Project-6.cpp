...
//bunny and sadsaa
Model bunny = Model("objects/bunny.obj");
Model sadsaa = Model("objects/sadsaa.obj");
...
static void display(void)
{
    ...
    //This is the skybox
     glPushMatrix();
        glScalef(25.0, 25.0, 25.0); //skybox 25 times bigger on all sides
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("Project 6: Bunny Loader");
